"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["ezplatform-admin-ui-subitems-js"],{
...
var ActionButton = function ActionButton(props) {
  ...
  attrs.className = (0,_common_helpers_css_class_names__WEBPACK_IMPORTED_MODULE_3__.createCssClassNames)((_createCssClassNames = {}, _defineProperty(_createCssClassNames, baseClassName, true), _defineProperty(_createCssClassNames, "".concat(baseClassName, "--disabled"), disabled), _defineProperty(_createCssClassNames, "".concat(baseClassName, "--").concat(type), !!type), _createCssClassNames));
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", attrs, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_icon_icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: type,
...
var NoItemsComponent = function NoItemsComponent() {
  var noItemsMessage = Translator.trans( /*@Desc("This location has no sub-items")*/'no_items.message', {}, 'sub_items');
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
var TableViewColumnsTogglerComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(TableViewColumnsTogglerComponent, [{
    ...
    value: function renderPanel() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", panelAttrs, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
...
var TableViewItemComponent = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(TableViewItemComponent, [{
    ...
    value: function renderNameCell() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", linkAttrs, contentName);
    }
    ...
    value: function renderTranslationsCell() {
      var _this$props2 = this.props,
        ...
        languages = _this$props2.languages;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, item.content._info.currentVersion.languageCodes.map(function (languageCode) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
          key: languageCode,
...
var ViewSwitcherButton = function ViewSwitcherButton(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", attrs, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_icon_icon__WEBPACK_IMPORTED_MODULE_2__["default"], iconAttrs));
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ViewSwitcherButton);
...
var ViewSwitcherComponent = function ViewSwitcherComponent(_ref) {
  ...
  var listViewBtnLabel = Translator.trans( /*@Desc("View as list")*/'switch_to_list_view.btn.label', {}, 'sub_items');
  var gridViewBtnLabel = Translator.trans( /*@Desc("View as grid")*/'switch_to_grid_view.btn.label', {}, 'sub_items');
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: componentClassName
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_view_switcher_button_component__WEBPACK_IMPORTED_MODULE_2__["default"], {
    id: "table",
    icon: "view-list",
...
var SubItemsModule = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SubItemsModule, [{
    ...
    value: function afterBulkMove(location, movedItems, notMovedItems) {
      ...
      if (notMovedItems.length) {
        ...
        var rawPlaceholdersMap = {
          moreInformationLink: Translator.trans( /*@Desc("<u><a class='ez-notification-btn ez-notification-btn--show-modal'>Click here for more information.</a></u><br>")*/
    ...
    value: function renderPaginationInfo() {
      ...
      var message = Translator.trans( /*@Desc("Viewing <strong>%viewingCount%</strong> out of <strong>%totalCount%</strong> sub-items")*/'viewing_message', {
    ...
    value: function renderBulkMoveBtn(disabled) {
      var label = Translator.trans( /*@Desc("Move selected items")*/'move_btn.label', {}, 'sub_items');
    ...
    value: function renderBulkAddLocationBtn(disabled) {
      var label = Translator.trans( /*@Desc("Add Locations to selected Content item(s)")*/'add_locations_btn.label', {}, 'sub_items');
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_action_btn_action_btn_js__WEBPACK_IMPORTED_MODULE_6__["default"], {
        disabled: disabled,
    ...
    value: function renderBulkHideBtn(disabled) {
      var label = Translator.trans( /*@Desc("Hide selected Locations")*/'hide_locations_btn.label', {}, 'sub_items');
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_action_btn_action_btn_js__WEBPACK_IMPORTED_MODULE_6__["default"], {
        disabled: disabled,
    ...
    value: function renderBulkUnhideBtn(disabled) {
      var label = Translator.trans( /*@Desc("Reveal selected Locations")*/'unhide_locations_btn.label', {}, 'sub_items');
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_action_btn_action_btn_js__WEBPACK_IMPORTED_MODULE_6__["default"], {
        disabled: disabled,
    ...
    value: function renderBulkDeleteBtn(disabled) {
      var label = Translator.trans( /*@Desc("Delete selected items")*/'trash_btn.label', {}, 'sub_items');
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_action_btn_action_btn_js__WEBPACK_IMPORTED_MODULE_6__["default"], {
        disabled: disabled,
...
/******/ var __webpack_exports__ = (__webpack_exec__("./vendor/ezsystems/ezplatform-admin-ui/src/bundle/ui-dev/src/modules/sub-items/sub.items.module.js"));
/******/ }
]);