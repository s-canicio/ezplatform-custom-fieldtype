"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["ezplatform-admin-ui-mfu-js"],{
...
var DropAreaComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DropAreaComponent, [{
    ...
    value: function render() {
      ...
      var dropActionMessage = Translator.trans( /*@Desc("Drag your files to the browser window or select them")*/'drop_action.message', {}, 'multi_file_upload');
      var uploadBtnLabel = Translator.trans( /*@Desc("Upload sub-items")*/'upload_btn.label', {}, 'multi_file_upload');
      ...
      }, dropActionMessage), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
        type: "button",
...
DropAreaComponent.propTypes = {
  onDrop: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func).isRequired,
...
var ProgressBarComponent = function ProgressBarComponent(props) {
  ...
  }, "".concat(props.progress, "%")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
ProgressBarComponent.propTypes = {
  ...
  uploaded: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string).isRequired,
  total: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string).isRequired
};
...
var UploadItemComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(UploadItemComponent, [{
    ...
    value: function renderIcon() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_icon_icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    value: function renderSuccessMessage() {
      ...
      var message = Translator.trans( /*@Desc("Uploaded")*/'upload.success.message', {}, 'multi_file_upload');
    ...
    value: function render() {
      ...
      }, this.state.uploaded ? this.state.totalSize : '')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "c-upload-list-item__info"
      }, this.renderErrorMessage(), this.renderSuccessMessage(), this.renderProgressBar()), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
UploadItemComponent.propTypes = {
  ...
  isUploaded: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool).isRequired,
...
var UploadListComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(UploadListComponent, [{
    ...
    value: function render() {
      ...
      }, this.props.uploadedItemsListTitle, " (", uploaded, "/", total, ")"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
UploadListComponent.propTypes = {
  ...
  uploadedItemsListTitle: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string).isRequired,
...
UploadPopupModule.propTypes = {
  ...
  onUploadEnd: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
  onUploadFail: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
  onItemEdit: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
  onItemRemove: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
  onClose: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
...
var MultiFileUploadModule = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MultiFileUploadModule, [{
    ...
    value: function renderBtn() {
      ...
      var title = Translator.trans( /*@Desc("Upload sub-items")*/'multi_file_upload_open_btn.label', {}, 'multi_file_upload');
      var attrs = {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", attrs, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_common_icon_icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
        name: "upload",
...
var getFieldDefinitionByIdentifier = function getFieldDefinitionByIdentifier(_ref2, contentTypeId, fieldIdentifier) {
  ...
  var request = new Request("/api/ezp/v2/content/types/".concat(contentTypeId, "/fieldDefinition/").concat(fieldIdentifier), {
    method: 'GET',
    headers: {
...
var prepareStruct = function prepareStruct(_ref3, data) {
  ...
  return getContentTypeByIdentifier(config, mapping.contentTypeIdentifier).then(function (response) {
    ...
    return window.eZ.helpers.notification.showErrorNotification(Translator.trans( /*@Desc("Cannot get content type by identifier")*/'cannot_get_content_type_identifier.message', {}, 'multi_file_upload'));
    ...
    return getFieldDefinitionByIdentifier(config, contentType.id, contentFieldIdentifier).then(function (response) {
      return response.json();
    })["catch"](function () {
      return window.eZ.helpers.notification.showErrorNotification(Translator.trans( /*@Desc("Cannot get content type by identifier")*/'cannot_get_content_type_identifier.message', {}, 'multi_file_upload'));
    }).then(function (response) {
      var fieldDefinition = response.FieldDefinition;
      ...
      return window.eZ.helpers.notification.showErrorNotification(Translator.trans( /*@Desc("Cannot create content structure")*/'cannot_create_content_structure.message', {}, 'multi_file_upload'));
    });
  })["catch"](function () {
    return window.eZ.helpers.notification.showErrorNotification(Translator.trans( /*@Desc("Cannot create content structure")*/'cannot_create_content_structure.message', {}, 'multi_file_upload'));
  });
...
/******/ var __webpack_exports__ = (__webpack_exec__("./vendor/ezsystems/ezplatform-admin-ui/src/bundle/ui-dev/src/modules/multi-file-upload/multi.file.upload.module.js"));
/******/ }
]);